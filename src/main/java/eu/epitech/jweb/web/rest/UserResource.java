...
import eu.epitech.jweb.domain.Authority;
import eu.epitech.jweb.domain.User;
import eu.epitech.jweb.repository.AuthorityRepository;
import eu.epitech.jweb.repository.UserRepository;
import eu.epitech.jweb.security.AuthoritiesConstants;
import eu.epitech.jweb.service.MailService;
import eu.epitech.jweb.service.UserService;
import eu.epitech.jweb.web.rest.dto.ManagedUserDTO;
import eu.epitech.jweb.web.rest.dto.UserDTO;
import eu.epitech.jweb.web.rest.util.HeaderUtil;
import eu.epitech.jweb.web.rest.util.PaginationUtil;
